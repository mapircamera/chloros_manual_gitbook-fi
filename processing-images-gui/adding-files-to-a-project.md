...
Kun olet luonut tai avannut projektin Chloros:ssä, seuraava vaihe on lisätä monispektrikuvat käsittelyn aloittamiseksi. Tiedostoselaimella<img src="../.gitbook/assets/icon_file-browser.JPG" alt="" data-size="line"> -välilehti helpottaa kuvien tuontia ja tietojoukon hallintaa.
...
* **Panoraama**: Napsauta ja vedä kuvaa, kun se on lähennetty***
...
**Ratkaisu**: Tarkista, että kameran aika-asetukset olivat oikein kuvauksen aikana***
...
3. **Merkitse kohdekuvat** – Katso [Kohdekuvien valitseminen](choosing-target-images.md)
